#ifndef UNDOCOMMANDDELETEROWBELOW_H
#define UNDOCOMMANDDELETEROWBELOW_H
...
/*!
 * \brief This class implements the functionality needed for the deletion of a row below the Battle Map and its undo mechanism.
 */
class UndoCommandDeleteRowBelow : public QUndoCommand
{
...
public:
     ...
     * \param   parent                        Parent of the class UndoCommandDeleteRowBelow                                                         *
     *                                                                                                                                              *
...
#endif // UNDOCOMMANDDELETEROWBELOW_H
