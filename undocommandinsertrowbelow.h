#ifndef UNDOCOMMANDINSERTROWBELOW_H
#define UNDOCOMMANDINSERTROWBELOW_H
...
/*!
 * \brief This class implements the functionality needed for the insertion of a row below the Battle Map and its undo mechanism.
 */
class UndoCommandInsertRowBelow : public QUndoCommand
{
...
public:
     ...
     * \param   parent                        Parent of the class UndoCommandInsertRowBelow                                                         *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
    UndoCommandInsertRowBelow(Ui::MainWindow *userInterface, BattleMap *battleMap, BattleMapSceneSection *battleMapSceneSection, MasterScreenHandler *masterScreenHandler, PlayerScreenHandler *playerScreenHandler, QUndoCommand *parent = nullptr);
     ...
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
    ~UndoCommandInsertRowBelow();

    /*! *********************************************************************************************************************************************
     * \brief   This function undos this command.                                                                                                   *
     *                                                                                                                                              *
     * \details This function deletes a row below the Battle Map and stores it in the member variable m_rowBelow for redoing the command.           *
     ...
     *                                                                                                                                              *
     * \details This function inserts a new row below the Battle Map, using the member variable m_rowBelow which is empty when the command is       *
	 *          initially applied, or otherwise contains the inserted row below which has previously been undone. Afterwards, it enables the        *
...
private:
    ...
    /*!
     * \brief This is the variable containing the Battle Map squares building the inserted Battle Map row.
     */
...
#endif // UNDOCOMMANDINSERTROWBELOW_H
