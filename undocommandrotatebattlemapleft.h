#ifndef UNDOCOMMANDROTATEBATTLEMAPLEFT_H
#define UNDOCOMMANDROTATEBATTLEMAPLEFT_H
...
/*!
 * \brief This class implements the functionality needed for the left rotation of the Battle Map and its undo mechanism.
 */
class UndoCommandRotateBattleMapLeft : public QUndoCommand
{
...
public:
     ...
     ************************************************************************************************************************************************/
    UndoCommandRotateBattleMapLeft(Ui::MainWindow *userInterface, BattleMap *battleMap, BattleMapSceneSection *battleMapSceneSection, MasterScreenHandler *masterScreenHandler, PlayerScreenHandler *playerScreenHandler, QUndoCommand *parent = nullptr);
     ...
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
    ~UndoCommandRotateBattleMapLeft();
...
#endif // UNDOCOMMANDROTATEBATTLEMAPLEFT_H
