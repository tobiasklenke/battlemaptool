#ifndef UNDOCOMMANDINSERTCOLUMNLEFT_H
#define UNDOCOMMANDINSERTCOLUMNLEFT_H
...
/*!
 * \brief This class implements the functionality needed for the insertion of a column to the left of the Battle Map and its undo mechanism.
 */
class UndoCommandInsertColumnLeft : public QUndoCommand
{
...
public:
     ...
     * \param   parent                        Parent of the class UndoCommandInsertColumnLeft                                                       *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
    UndoCommandInsertColumnLeft(Ui::MainWindow *userInterface, BattleMap *battleMap, BattleMapSceneSection *battleMapSceneSection, MasterScreenHandler *masterScreenHandler, PlayerScreenHandler *playerScreenHandler, QUndoCommand *parent = nullptr);
...
#endif // UNDOCOMMANDINSERTCOLUMNLEFT_H
