...
private slots:
     ...
     *          initial functional role for the Battle Map image source selection. Afterwards, the function resets and reconnects the Battle Map    *
     *          scene.                                                                                                                              *
     *                                                                                                                                              *
     ...
     *          selected source with the text string of LineEdit_Source. Since LineEdit_Source is edited this way, the function calls the           *
     *          corresponding function that handles the editing of LineEdit_Source.                                                                 *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
     ...
     *          positive numeric value. Otherwise, the function shows a warning message box. Afterwards, the function enables or disables the       *
     *          widget PushButton_DecrementNumberRows depending on whether the number of rows is greater than 0. Finally, the function corrects the *
     *          number of columns, checks and draws the Battle Map grid if the widget RadioButton_SourceBattleMap is checked, or checks the Battle  *
     *          Map grid and shows the empty Battle Map image if the widget RadioButton_EmptyBattleMap is checked.                                  *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
     ...
     *                                                                                                                                              *
     * \details This function checks the input text string for validity and updates the number of columns if the input text string is interpretable *
     *          as positive numeric value. Otherwise, the function shows a warning message box. Afterwards, the function enables or disables the    *
     *          widget PushButton_DecrementNumberColumns depending on whether the number of columns is greater than 0. Finally, it corrects the     *
     ...
     *          depending on whether the number of rows is greater than 0. Finally, the function corrects the number of columns, checks and draws   *
     *          the Battle Map grid if the widget RadioButton_SourceBattleMap is checked, or checks the Battle Map grid and shows the empty Battle  *
     *          Map image if the widget RadioButton_EmptyBattleMap is checked.                                                                      *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
     ...
     *                                                                                                                                              *
     * \details This function increments the number of rows. Afterwards, the function corrects the number of columns, checks and draws the Battle   *
     *          Map grid if the widget RadioButton_SourceBattleMap is checked, or checks the Battle Map grid and shows the empty Battle Map image   *
     *          if the widget RadioButton_EmptyBattleMap is checked.                                                                                *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
     ...
     *                                                                                                                                              *
     * \details This function increments the number of columns. Afterwards, the function corrects the number of rows, checks and draws the Battle   *
     *          Map grid if the widget RadioButton_SourceBattleMap is checked, or checks the Battle Map grid and shows the empty Battle Map image   *
     *          if the widget RadioButton_EmptyBattleMap is checked.                                                                                *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ...
     *                                                                                                                                              *
     * \details This function determines the edge lengths of the selected Battle Map square and their average value. If the average edge length is  *
     *          not greater than 0, no Battle Map square has been selected and the function resets the number of rows and columns, disables the     *
     *          push button from DialogButtonBox with AcceptRole and removes the current Battle Map grid. Otherwise, the function optimizes the     *
     *          edge length by performing a modulo operation with the height of the Battle Map image and the edge length with the goal of           *
     *          minimizing the residual to 0. This is done twice by incrementing and decrementing the edge length. The edge length that results     *
     *          from the optimization with fewer iterations is then used for the calculation of the number of rows and columns considering the size *
     *          of the Battle Map image. Afterwards, the function enables the widgets for editing of numbers of rows and columns and the push       *
     *          button from DialogButtonBox with AcceptRole. The function checks and draws the Battle Map grid. Finally, the function shows a       *
     *          question message box which asks the user to check the Battle Map grid and readjust the number of rows and columns in case of        *
     *          mismatch.                                                                                                                           *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
...
private:
     ...
     *          configured file path and checks it for validity. If the loaded file is no image or it is but has no square format, the function     *
     *          shows a warning message box. Otherwise, the function scales the Battle Map square image to the configured size and constructs the   *
     ...
     *          adds the empty Battle Map image to the Battle Map scene and draws the Battle Map grid.                                              *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
     ...
     *                                                                                                                                              *
     * \details This function resets and reconnects the Battle Map scene. Afterwards, it loads the Battle Map image from the selected source and    *
     *          checks it for validity. If the loaded file is no image, the function shows a warning message box. Otherwise, the function adds the  *
     *          Battle Map image to the Battle Map scene and shows a question message box that asks the user to select a Battle Map square in order *
     *          to determine the number of rows and columns of the Battle Map.                                                                      *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
     ...
     *          ratio. Afterwards, the function enables or disables the widget PushButton_DecrementNumberRows depending on whether the number of    *
     ...
     *                                                                                                                                              *
     * \details If the number of rows is greater than 0, this function corrects the number of columns considering the Battle Map squares aspect     *
     *          ratio. Afterwards, the function enables or disables the widget PushButton_DecrementNumberColumns depending on whether the number of *
     *          rows is greater than 0.                                                                                                             *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
     ...
     *                                                                                                                                              *
     * \details This function removes the current Battle Map grid and redraws it depending on the number of rows and columns if both are greater    *
     *          than 0. If the widget CheckBox_DrawBattleMapGrid is checked, the function draws solid lines using the configured pen options.       *
     *          Otherwise, the function draws dotted lines.                                                                                         *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
