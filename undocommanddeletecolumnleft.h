...
public:
     ...
     *                                                                                                                                              *
     * \details This function inserts a new column to the left of the Battle Map, using the member variable m_columnLeft which contains the column  *
     *          that has previously been deleted. Afterwards, it enables the actions for decrement depending on the current number of columns and   *
     *          it checks whether the number of columns displayable on the player screen is greater than or equal to the total number of columns of *
     *          the Battle Map. If so, it increments the number of columns of the Battle Map scene section. Otherwise, it increments the index of   *
     *          the first column of the Battle Map scene section. Finally, it calls the respective functions of the screen handlers for inserting   *
     *          new Battle Map square graphics items.                                                                                               *
     *                                                                                                                                              *
     * \return  This function does not have any return value.                                                                                       *
     ************************************************************************************************************************************************/
    void undo() override;
     ...
     *                                                                                                                                              *
     * \details This function deletes a column to the left of the Battle Map and stores it in the member variable m_columnLeft for undoing the      *
